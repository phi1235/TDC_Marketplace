...
class BulkListingSeeder extends Seeder
{
    public function run()
    {
        ...
        $this->generateListingsInBatches($count, $users, $categories);
    ...
    private function generateListingsInBatches($count, $users, $categories)
    {
        ...
        // Generate listings in batches of 100
        $batchSize = 100;
        ...
        for ($batch = 0; $batch < $batches; $batch++) {
            ...
            foreach ($listingIds as $listingId) {
                ...
                for ($j = 0; $j < $imageCount; $j++) {
                    $images[] = [
                        ...
                        'original_name' => 'sample_' . uniqid() . '.jpg',
            ...
            if (!empty($images)) {
                DB::table('listing_images')->insert($images);
            }
